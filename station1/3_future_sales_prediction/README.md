...
We have datapoints for the Sales label with respect to the amount of TV, Radio and Newspaper (these are the features) advertisement budget for the same time period.
...
The resulting precision is aroun 90% for the training set, and around 80% for the test set, which also looks realistic and good.
